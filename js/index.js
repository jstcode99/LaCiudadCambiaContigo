...
function chargeDataCards(newData) {
  currentPage = 1
  data = newData
  changePage(1);
}
...
function changePage(page){
  document.getElementById('currentPage').textContent = currentPage + '/' + numPages()
